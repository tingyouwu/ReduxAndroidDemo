 ...
 * @Desc 负责分发Action
 **/
public class ChangeTextActionCreater extends ReduxActionCreater{
    public void changeText() {
        dispatch(new ReduxAction(ChangeTextReduce.ACTION_SHOWLOADING));
    ...
    private void showText() {
        ReduxAction action = new ReduxAction(ChangeTextReduce.ACTION_SHOWTEXT);
